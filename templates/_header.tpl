...
<nav class="menu row">
	<ul>
                <li class="span1"><a class="link" href="{$baseURL}/events" {if isset($where) && $where == 'events'}class="active"{/if}>Events </a></li>
                 <li class="span1"><a class="link" href="{$baseURL}/video" {if isset($where) && $where == 'video'}class="active"{/if}>Videos </a></li>

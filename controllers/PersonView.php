...
//function
    ...
    public function locations() {
     ...
     /** ----------------------------------------------------------------------------------------------------
     * Cette mŽthode qui est dŽclenchŽ quand l'utilisateur a prŽssŽ sur le boutton submit dans le formulaire
      * locations.Elle prends les donnŽes de la variable $_POST et le mets dans l'array $args.
    ...
    /** ----------------------------------------------------------------------------------------------------
     * Cette mŽthode qui est dŽclenchŽ quand l'utilisateur a prŽssŽ sur le boutton submit dans le formulaire
      * register to an event. Elle vŽrifie si l'utilisateur est loggŽ, si pas il affiche le template register.
     * Ensuite elle prends les donnŽes de la variable $_POST et l'envoye ˆ le service fonctionnel de la classe
     * tedx_manager en appelant la mŽthode registerToAnEvent.  
     * Maitenant l'utilisateur peut entrer sa motivation et ses keywords pour poser sa demande d'admission aux 
     * organisateurs.
     * @param:
     *          $eventId -> le numŽro d'authentification de l'id sur quel l'utilisateur aimerait participer.
     */
    public function registerToAnEventSubmit($eventId) {
      ...
      /** ----------------------------------------------------------------------------------------------------
     * Cette mŽthode cherche toute les roles et les organiseurs existants et l'envoye au 
...
// Message
      ...
      /** ----------------------------------------------------------------------------------------------------
     * Cette mŽthode s'enclenche quand l'utilisateur ˆ prŽssŽ sur submit dans le template
